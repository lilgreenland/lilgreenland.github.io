...
document.getElementById(canvasID).addEventListener("mousedown", function(){
  ...
  spawnMass(0, 130, 300, 0, 20, 0.02);
  spawnMass(0, 230, 300, 0, 20, 0.01);
  spawnMass(0, 330, 300, 0, 20, 0.005);
});
...
World.add(engine.world, [
    Bodies.rectangle(canvas.width*0.5, 100, canvas.width, 10, {
      isStatic: true,
      friction: 1,
      frictionStatic: 1,
    }),
    Bodies.rectangle(canvas.width*0.5, 200, canvas.width, 10, {
      isStatic: true,
      friction: 1,
      frictionStatic: 1,
    }),
    Bodies.rectangle(canvas.width*0.5, 300, canvas.width, 10, {
      isStatic: true,
      friction: 1,
      frictionStatic: 1,
    })
