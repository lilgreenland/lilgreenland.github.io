...
document.getElementById(canvasID).addEventListener("mousedown", function(){
  ...
  spawnMass(100, 100, 120, 0,  20+Math.round(Math.random()*70),Math.random());
  spawnMass(600, 100, -120, 0, 20+Math.round(Math.random()*70),Math.random());
});
spawnMass(100, 100, 200, 0,  20+Math.round(Math.random()*70),Math.random());
spawnMass(600, 100, -200, 0, 20+Math.round(Math.random()*70),Math.random());
