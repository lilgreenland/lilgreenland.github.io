...
function spawnList(){
  ...
  spawnMass(100, Ypos, Math.ceil(Math.random()*10)*15, 0, 20+Math.ceil(Math.random()*60),8,0.1);
  spawnMass(600, Ypos, -Math.ceil(Math.random()*10)*15, 0, 20+Math.ceil(Math.random()*60),4,1.5);
